...
const NFTDescription = ({ nft }) => {
  ...
  // SMART CONTRACT DATA
    ...
    // Initialize currentAccount as an empty string if not provided
...
{/* Gemini Helped */}
            {currentAccount.toLowerCase() === nft.seller?.toLowerCase() ? ( // Added optional chaining
        <p>You cannot buy your own NFT</p>
      ) : currentAccount.toLowerCase() === nft.owner?.toLowerCase() ? ( // Added optional chaining
